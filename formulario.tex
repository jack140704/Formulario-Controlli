...
\begin{itemize}[leftmargin=12pt, nosep, before=\vspace{-2pt}, after=\vspace{-2pt}]
    \item[a.] portare $\omega_{c,des}$ in corrispondenza di 0 dB
    \item[b.] portare il diagramma fuori dalla regione proibita
\end{itemize}

\sub{Passo 3: Simulazione}
Simulare con \texttt{step(T/(Gs*Gf))} per le specifiche in transitorio. (Le altre su inseguimento e disturbi sono verificate se $K_c$ e $\nu$ sono OK).
