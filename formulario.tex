...
($p$: poli nell'origine di $G_p$ spostati in cost.\ tempo)\\
...
\[
|K_c|\geq\frac{|D_{a,0}|}{\varepsilon_{d_a}\,|G_a\,G_s\,G_F|}\quad\text{se } \varepsilon_{d_a}\neq 0\ \Rightarrow\ \nu\geq h_a
\]
\[
...
\emph{Polinomiale:}
\[
|K_c|\geq\frac{|D_{p,0}|}{\varepsilon_{d_p}\,|G_a\,G_s\,G_F\,K_p|}\quad\text{se } \varepsilon_{d_p}\neq 0\ \Rightarrow\ \nu\geq h_p-p
\]
\[
...
\]
\[
T_{p,0}=\frac{1}{2\zeta\sqrt{1-\zeta^{2}}}
\]
\[
S_{p,0}=\frac{2\zeta\sqrt{2+4\zeta^{2}+2\sqrt{1+8\zeta^{2}}}}{\sqrt{1+8\zeta^{2}}+4\zeta^{2}-1}
\]
